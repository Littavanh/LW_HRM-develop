...
class EmpOTReqItem extends StatelessWidget {
  final OTRequest request;
  final Function reloadData;
  EmpOTReqItem({@required this.request, @required this.reloadData});
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'NO: ${request.otRequestNo}',
                                  style: new TextStyle(),
                                ),
                                Text(
                                  'ID: ${request.otRequestId}',
                                  style: new TextStyle(),
                                ),
                              ],
                            ),
  ...
  void _toToDetailsScreen(context) async {
    Map<String, dynamic> arg = {'requestType': "OT", 'data': request};
