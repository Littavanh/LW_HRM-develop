...
import 'package:LTL_HRM/models/calenderPodo.dart';
    ...
    myRequestMain.resultObject.forEach((element) {
      element.Events.forEach((element2) {
        final DateTime today =
            DateFormat("MM/dd/yyyy").parse(element2.eventDate.split(" ")[0]);
        final DateTime startTime =
            DateTime(today.year, today.month, today.day, 9, 0, 0);
        final DateTime endTime =
            DateTime(today.year, today.month, today.day, 18, 0, 0);
        meetings.add(
            Meeting(element2.eventNoted, startTime, endTime, Colors.red, true));
      });
    });
